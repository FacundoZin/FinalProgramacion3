...
3. La API por defecto queda en `https://localhost:50659` (o la URL que te indique la consola).
...
1. Abrí otra terminal y ejecutá:
...
> Si tu backend corre en otra URL distinta de `https://localhost:50659`, cambiá la constante `API_BASE` en los archivos de vistas (`ClientsView.vue`, `TransactionsView.vue`, etc.).
